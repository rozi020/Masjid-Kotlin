...
class IdentitasMasjid : AppCompatActivity() {
    ...
    fun getnama(){
        AndroidNetworking.get("http://192.168.0.8/cobarepo-master/indentitas-masjid-json.php")
    ...
    fun postidentitas(data1:String, data2:String){
        ...
        AndroidNetworking.post("http://192.168.0.8/cobarepo-master/proses-identitas.php")
