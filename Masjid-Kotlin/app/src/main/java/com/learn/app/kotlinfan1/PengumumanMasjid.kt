...
class PengumumanMasjid : AppCompatActivity() {
    ...
    fun getjudul(){
        AndroidNetworking.get("http://192.168.0.8/cobarepo-master/pengumuman-masjid-json.php")
    ...
    fun postpengumuman(data1:String, data2:String){
        ...
        AndroidNetworking.post("http://192.168.0.8/cobarepo-master/proses-pengumuman.php")
