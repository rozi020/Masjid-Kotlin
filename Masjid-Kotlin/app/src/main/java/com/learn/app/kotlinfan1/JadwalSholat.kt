...
class JadwalSholat : AppCompatActivity() {
    ...
    fun getshubuh(){
        AndroidNetworking.get("http://192.168.0.8/cobarepo-master/contoh_jadwal_json.php")
    ...
    fun postshubuh(data1:String){
        ...
        AndroidNetworking.post("http://192.168.0.8/cobarepo-master/proses-shubuh.php")
    ...
    fun postdhuhur(data2:String){
        ...
        AndroidNetworking.post("http://192.168.0.8/cobarepo-master/proses-dhuhur.php")
    ...
    fun postashar(data3:String){
        ...
        AndroidNetworking.post("http://192.168.0.8/cobarepo-master/proses-ashar.php")
    ...
    fun postmaghrib(data4:String){
        ...
        AndroidNetworking.post("http://192.168.0.8/cobarepo-master/proses-maghrib.php")
    ...
    fun postisha(data5:String){
        ...
        AndroidNetworking.post("http://192.168.0.8/cobarepo-master/proses-isha.php")
    ...
    fun postdhuha(data6:String){
        ...
        AndroidNetworking.post("http://192.168.0.8/cobarepo-master/proses-dhuha.php")
